					...
					<section className="text-center">
						<div class="jumbotron jumbotron-fluid">
							<div class="container">
								...
								<p class="lead"> Cuando adquieres una de nuestras bicicletas, no solo adquieres una nueva compañera de aventura, esta también viene acompañada de una serie de beneficios que te ofrecemos por haber decidido ser parte de nuestra comunidad como lo son :</p>
							</div>
						</div>
					</section>
